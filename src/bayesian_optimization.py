...
def objective(trial, X_train, y_train):
    ...
    Trains a decision tree classifier on the input training data with the hyperparameters sampled from the trial.
...
def main():
    ...
    best_params, num_trials = tune_hyperparameters(X_train, y_train, n_trials=20)
